...
class FederatedDataset:
    ...
    def __init__(self, args: Namespace) -> None:
        ...
        self.test_loader = []
        self.args = args
        FederatedDataset.model_args = args
...
def partition_digits_domain_skew_loaders(train_datasets: list, test_datasets: list, model_name: str, 
                                         setting: FederatedDataset) -> Tuple[list, list]:
    ini_len_dict = {}
    not_used_index_dict = {}

    # if model_name == 'fpl':
    #     # setting.percent_dict = {'mnist': 0.01, 'usps': 0.01, 'svhn': 0.015, 'syn': 0.025} 
    #     setting.percent_dict = {'mnist': 0.01, 'usps': 0.01, 'svhn': 0.01, 'syn': 0.01} 
    
    # if model_name == 'feddyn':
    #     setting.percent_dict = {'mnist': 0.01, 'usps': 0.01, 'svhn': 0.015, 'syn': 0.02} 

    # if model_name == 'moon':
    #     setting.percent_dict = {'mnist': 0.01, 'usps': 0.02, 'svhn': 0.02, 'syn': 0.02} 
...
def partition_office_domain_skew_loaders_new(train_datasets: list, test_datasets: list, model_name: str, 
    ...
    # if model_name == 'fpl':
    #     setting.percent_dict = {'caltech': 0.2, 'amazon': 0.2, 'webcam':0.3, 'dslr': 0.3} 
    
    # if model_name == 'feddyn':
    #     setting.percent_dict = {'caltech': 0.2, 'amazon': 0.2, 'webcam':0.2, 'dslr': 0.3} 
...
def partition_pacs_domain_skew_loaders(train_datasets: list, test_datasets: list, model_name: str, 
                                       setting: FederatedDataset) -> Tuple[list, list]:
    ini_len_dict = {}
    not_used_index_dict = {}
    all_labels_list = []
    ...
    # if model_name == 'fpl':
    #     setting.percent_dict = {'photo':0.3, 'art':0.4, 'cartoon':0.3, 'sketch':0.4} 
    
    # if model_name == 'f2dc':
    #     setting.percent_dict = {'photo':0.3, 'art':0.4, 'cartoon':0.3, 'sketch':0.4} 

    # if model_name == 'fedproc':
    #     setting.percent_dict = {'photo':0.3, 'art':0.4, 'cartoon':0.3, 'sketch':0.4}
    ...
    # if model_name == 'feddyn':
    #     setting.percent_dict = {'photo': 0.3, 'art': 0.35, 'cartoon':0.3, 'sketch': 0.35} 
